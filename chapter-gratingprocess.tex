...
\subfloat[Projected photoresist interference curve]{\psfig{file=S1800interference,height=2.75in,width=3.25in}}
\\
\subfloat[Center to edge variation assuming the projected interference]{\psfig{file=projectedC2Evariation,height=2.75in,width=3.25in}}
...
\begin{figure}[h!] 
\begin{center}
\psfig{file=UV_spec_abs,height=3.0in,width=3.50in}
...
\begin{figure}[h!] 
\begin{center}
\ \psfig{file=UV_expos_graphic2.pdf,height=4.5in,width=4in}
...
\begin{figure}[h!] 
\begin{center}
\ \psfig{file=UV_expos_graphic1.pdf,height=4.5in,width=4in}
...
\begin{figure}[h!] 
\begin{center}
\ \psfig{file=dose2clear.pdf,height=4in,width=5.5in}
...
\begin{figure}[h!] 
\begin{center}
\ \psfig{file=dose2clear2.pdf,height=4in,width=5.5in}
...
\begin{figure}[h!] 
\begin{center}
\ \psfig{file=IMG_3285.jpg,height=5in,width=4in}
...
\begin{figure}[h!] 
\begin{center}
\ \psfig{file=3Dzoomw20120926.pdf,height=5in,width=6.25in}
...
\begin{figure}[h!] 
\begin{center}
\subfloat[Schematic of the Wafer and UV slit motion]{\ \psfig{file=UV_slit,height=2in,width=3in}}
\\
\subfloat[Vibration effect on position and dwell time]{\ \psfig{file=UV_vibrations,height=3in,width=6in}}
...
\begin{figure}[h!] 
\begin{center}
\ \psfig{file=zeiss_period,height=4.6in,width=6in}
...
\begin{figure}[h!] 
\begin{center}
\ \psfig{file=resonantmotor.pdf,height=2.5in,width=3.5in}
...
\begin{figure}[h!] 
\begin{center}
\ \psfig{file=freqresponse.pdf,height=2.5in,width=3.5in}
