...
\begin{figure}
  \centering
  \subfloat[CA1a photo]{\label{fig:CA1aphoto}\includegraphics[height=5cm]{ca1_bartest2}}
	~
%  \subfloat[CA1a drawing]{\label{fig:CA1adraw}\includegraphics[page=1, trim=24cm 15.15cm 2cm 5cm, clip=true, totalheight=0.2\textheight ]{APRA_BOULE_29MM_R3_CA1_X14_2011-03-08}}
   \subfloat[CA1a drawing]{\label{fig:CA1adraw}\includegraphics[height=4cm]{ca1a_drawing}}
...
%-------------
   ...
   \begin{center}
   \begin{tabular}{c}
   \includegraphics[height=7cm]{CA1_SEM_cross3}
   \end{tabular}
   \end{center}
...
\begin{center}
 \begin{tabular}{c}
    \includegraphics[width=1.0\textwidth]{CA1a_1500_2300_eff.pdf}
   \end{tabular}
  \end{center}
...
\begin{center}
 \begin{tabular}{c}
    \includegraphics[width=1.0\textwidth]{CA1a_diffrac}
   \end{tabular}
  \end{center}
...
\begin{figure}
  \centering
\includegraphics[width=0.9\textwidth]{CA1a_fig_scl2}
...
\begin{figure}
\begin{center}
 \subfloat[2D Zygo PSF]{\label{fig:zygoPSF2D} \includegraphics[width=0.45\textwidth]{CA1a_ghost_zygo_2d}}
 \subfloat[1D Log PSF]{\label{fig:logPSF1D} \includegraphics[width=0.45\textwidth]{CA1a_ghost_1d}}   
  \end{center}
...
\begin{figure}
\begin{center}
    \includegraphics[width=1.0\textwidth]{GTA_cam_model_ref_tilt.jpg}
  \end{center}
