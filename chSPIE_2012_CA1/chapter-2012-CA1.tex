...
\begin{figure}
  \centering
  \subfloat[CA1a photo]{\label{fig:CA1aphoto}\includegraphics[height=4cm]{chSPIE_2012_CA1/figs/ca1_bartest2}}
	~
   \subfloat[CA1a drawing]{\label{fig:CA1adraw}\includegraphics[height=3.5cm]{chSPIE_2012_CA1/figs/ca1a_drawing}}
...
\begin{figure}
\begin{center}
 \subfloat[2D Zygo PSF]{\label{fig:zygoPSF2D} \includegraphics[width=0.48\textwidth]{chSPIE_2012_CA1/figs/CA1a_ghost_zygo_2d}}
 \subfloat[1D Log PSF]{\label{fig:logPSF1D} \includegraphics[width=0.48\textwidth]{chSPIE_2012_CA1/figs/CA1a_ghost_1d}}   
  \end{center}
