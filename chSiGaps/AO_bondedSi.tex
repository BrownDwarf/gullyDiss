...
\input{chSiGaps/tbls/tbl_experiments.tex}

\input{chSiGaps/tbls/tbl_meshPatterns.tex}
...
\input{chSiGaps/tbls/tbl_cary5000Pars.tex}
...
\input{chSiGaps/tbls/tbl_DerivedGapSizes}


\begin{figure}[htbp]
    \centering
    \subfloat[][Fitted gap size $d$ and fill factor $f$ for VG03 hole region]{\includegraphics[width=0.5\textwidth]{chSiGaps/figs/VG03_corner.pdf} \label{figVG03_corner}}
    	 \newline
    \subfloat[][Measured spectrum and fit of VG03 hole region]{\includegraphics[width=0.5\textwidth]{chSiGaps/figs/VG03_f100.pdf} \label{figVG03_f100}}
...
\begin{figure}[htbp]
    \centering
    \subfloat[][Fitted gap size $d$ and fill factor $f$ for VG03 petal region]{\includegraphics[width=0.5\textwidth]{chSiGaps/figs/VG03p2_corner.pdf} \label{figVG03p2_corner}}
    	\newline
    \subfloat[][Measured spectrum and fit of VG03 petal region]{\includegraphics[width=0.5\textwidth]{chSiGaps/figs/VG03_f045.pdf} \label{figVG03_f045}}
...
\begin{figure}[htbp]
    \centering
    \subfloat[][Illustration of VG09-12 sample transport accessory measurement positions.]{\includegraphics[width=0.3\textwidth]{chSiGaps/figs/VG09_12_STA_illustration.pdf} \label{figVG0912_STA_illus}}
    \newline
    \subfloat[][Measured gap transmission spectra of VG09-12 on- and off- mesh ]{\includegraphics[width=0.8\textwidth]{chSiGaps/figs/VG0912_STA_scan_coarse.pdf} \label{figVG0912}}
...
\begin{figure}[htbp]
    \centering
    \subfloat[][Fitted gap size $d$ and fill factor $f$ for VG09-12 off-mesh]{\includegraphics[width=0.5\textwidth]{chSiGaps/figs/VG0912_0gap_corner.pdf} \label{VG0912_0gap_corner}}
    \newline
    \subfloat[][Measured spectrum of VG09-12]{\includegraphics[width=0.65\textwidth]{chSiGaps/figs/VG0912_0gap.pdf} \label{VG0912_0gap}}
