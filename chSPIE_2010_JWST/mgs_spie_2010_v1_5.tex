...
\title{High Performance Silicon Grisms for 1.2-8.0 {\LARGE$\bm{\mu}$}m: Detailed Results from the JWST-NIRCam Devices} 


\author{M. Gully-Santiago\supit{a}, W. Wang\supit{a}, C. Deen\supit{a}, D. Kelly\supit{b}, T.P. Greene\supit{c}, J. Bacon\supit{d}, and D.T. Jaffe\supit{a}
\skiplinehalf
\supit{a}University of Texas at Austin Department of Astronomy, Austin, TX, USA \\
\supit{b}University of Arizona, Department of Astronomy, Tucson, AZ, USA \\
\supit{c}NASA Ames Research Center, Moffett Field, CA, USA \\
\supit{d}II-VI Incorporated, Saxonburg, PA, USA
}
...
\authorinfo{Send correspondence to M.G.S\\gully@astro.as.utexas.edu}
...
\keywords{Ground based astronomy, diffraction gratings, optical materials}
