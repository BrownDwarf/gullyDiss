...
\begin{figure}[h!] 
\begin{center}
\ \psfig{file=Rnum,height=4.25in,width=5.5in}
...
\begin{figure}[h!] 
\begin{center}
\ \psfig{file=gt_geom_blockage.pdf,height=3in,width=6.4in}
...
\begin{figure}[h!] 
\begin{center}
\ \psfig{file=IG_blaze_design,height=6.5in,width=3.25in}
...
\begin{figure}[h!] 
\begin{center}
\ \psfig{file=scarp_reflect.pdf,height=2.0in,width=6.3in}
